...
> Flavor de roles: **lean** (3 roles). Tracking en `tracking/`. Las notas previas `BACKLOG.md`/`TODO.md`/`ROADMAP.md` (raíz) siguen siendo la fuente de ideas hasta migrarse a `tracking/PENDING.md`.
