...
- [ ] **Exploración: "forks" no canon** (Marcos decide): 4 localizaciones comunes (Moonshine Stash, Heavy Weapons Cache, Trench Shrine, Ruined House) tienen variantes inventadas para cuando se redescubren (Destilería oculta +40 👑, Búnker improvisado +50 👑, Capilla derruida, Sótano saqueado…). Rulebook 1.0.2: redescubrir una localización es un resultado *Pillaged* (no encuentras nada). Opciones: quitarlas (canon) o dejarlas como house rule opcional.
